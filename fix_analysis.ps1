...
foreach($line in $lines) {
    if($line.Contains("// === Indicators Encyclopedia")) {
        break
    }
    $keep += $line
}

# 使用 '@' (單引號) 確保內容不會被 PowerShell 解析
$encyclopedia = @'
...
const termDefinitions = {
    ...
    '本益比': {
        ...
        rules: '<li><b><12倍</b>: 相對便宜，回本速度快。</li><li><b>15-20倍</b>: 合理區間，與大多數公司同步。</li><li><b>>25倍</b>: 偏貴，市場給予高期待，需有高成長支撐。</li>',
...
$keep | Set-Content $path -Encoding UTF8
Add-Content $path $encyclopedia -Encoding UTF8
Write-Host "Repair Finished Successfully!"
